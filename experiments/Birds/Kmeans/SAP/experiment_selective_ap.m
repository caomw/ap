...
%   -K-means to build weak input partitions
...
exp_name = 'Selective-AP-Birds-Kmeans';
...
k=200;
%Read ground truth labels for the dataset
disp('Reading ground truth data and descriptors')
cl = load([data_path 'ground_truth_birds.txt']);
ground_truth = cl;
cl = cl';
...
%LLC
descriptors = load([data_path 'descriptors/LLC_birds.txt']);
